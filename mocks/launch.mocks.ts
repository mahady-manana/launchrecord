...
export const mockFeaturedLaunch: Launch = {
  ...
  authorX: "@launchrecord",
  authorLinkedIn: "https://linkedin.com/company/launchrecord",
  placement: "hero",
...
export const mockLaunches: Launch[] = [
  {
    ...
    authorX: "@projectalpha",
    authorLinkedIn: "https://linkedin.com/company/projectalpha",
    placement: "none",
  ...
  },
  {
    ...
    businessModel: "B2B",
    pricingModel: "paid",
    authorName: "Beta Team",
    authorX: "@betaanalytics",
    authorLinkedIn: "https://linkedin.com/company/betaanalytics",
    placement: "left",
  ...
  },
  {
    ...
    businessModel: "B2C",
    pricingModel: "freemium",
    authorName: "Gamma Team",
    authorX: "@gammadesign",
    authorLinkedIn: "https://linkedin.com/company/gammadesign",
    placement: "right",
