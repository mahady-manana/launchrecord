...
export default function PositioningReportsPage() {
  ...
  const getBadgeColor = (
    ...
    const colorMap: Record<string, string> = {
      ...
      "Highly Unique": "bg-green-100 text-green-700 border-green-200",
      "Laser-Focused": "bg-green-100 text-green-700 border-green-200",
      Comprehensive: "bg-green-100 text-green-700 border-green-200",
      Dominant: "bg-green-100 text-green-700 border-green-200",

      Clear: "bg-lime-100 text-lime-700 border-lime-200",
      Distinctive: "bg-lime-100 text-lime-700 border-lime-200",
      Specific: "bg-lime-100 text-lime-700 border-lime-200",
      Detailed: "bg-lime-100 text-lime-700 border-lime-200",
      Strong: "bg-lime-100 text-lime-700 border-lime-200",

      Moderate: "bg-yellow-100 text-yellow-700 border-yellow-200",
      Generic: "bg-yellow-100 text-yellow-700 border-yellow-200",
      Basic: "bg-yellow-100 text-yellow-700 border-yellow-200",
      Blended: "bg-yellow-100 text-yellow-700 border-yellow-200",

      Unclear: "bg-orange-100 text-orange-700 border-orange-200",
      Common: "bg-orange-100 text-orange-700 border-orange-200",
      Vague: "bg-orange-100 text-orange-700 border-orange-200",
      Minimal: "bg-orange-100 text-orange-700 border-orange-200",
      Weak: "bg-orange-100 text-orange-700 border-orange-200",
      Inconsistent: "bg-orange-100 text-orange-700 border-orange-200",

      Absent: "bg-red-100 text-red-700 border-red-200",
      Undefined: "bg-red-100 text-red-700 border-red-200",
    ...
    return colorMap[value] || "bg-slate-100 text-slate-700 border-slate-200";
  };
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>How well you define your audience</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div>
