...
export default function FounderProofAuditPage() {
  ...
  const handleRunAudit = () => {
    alert(
      "Founder Proof Audit is coming soon! AEO Audit is currently available.",
    );
  };
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          disabled={isRunning}
          className="bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:from-purple-700 hover:to-pink-700 relative"
        >
          {isRunning ? (
            <>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-purple-100">
                Visitors need reasons to believe. Social proof, authority
                signals, and credibility markers convert skepticism into trust.
              </p>
            </div>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            How much trust do visitors place in you?
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-3">
            {[
              ...
              <div
                key={idx}
                className="flex items-center gap-4 p-4 rounded-xl border border-slate-200 hover:border-purple-300 transition-colors"
              >
                <div
                  className={`h-12 w-12 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center text-white flex-shrink-0`}
                >
                  {item.icon}
                </div>
                <div className="flex-1">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Six credibility markers that build trust
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            {[
              {
                ...
                label: "Testimonials",
                desc: "Customer quotes & endorsements",
                color: "text-purple-600 bg-purple-100",
              },
              {
                icon: <Users className="h-5 w-5" />,
                label: "Case Studies",
                desc: "Detailed success stories",
                color: "text-pink-600 bg-pink-100",
              },
              {
                icon: <Award className="h-5 w-5" />,
                label: "Metrics",
                desc: "Specific numbers & outcomes",
                color: "text-rose-600 bg-rose-100",
              },
              {
                icon: <BadgeCheck className="h-5 w-5" />,
                label: "Press Features",
                desc: "Media coverage & mentions",
                color: "text-orange-600 bg-orange-100",
              },
              {
                icon: <Star className="h-5 w-5" />,
                label: "Trust Badges",
                desc: "Security & guarantees",
                color: "text-yellow-600 bg-yellow-100",
              },
              {
                icon: <Heart className="h-5 w-5" />,
                label: "Founder Story",
                desc: "Origin & expertise",
                color: "text-red-600 bg-red-100",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="flex items-start gap-3 p-4 rounded-xl border border-slate-200 hover:border-purple-300 transition-colors"
              >
                <div
