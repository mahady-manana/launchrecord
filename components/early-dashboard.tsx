            ...
            <Card className="border-2 border-green-200 bg-green-50">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-green-700 mb-4">
                  As an early access member, you'll receive weekly updates, new
                  features, and priority support. Keep up for more insights and
                  tools to strengthen your positioning.
                </p>
              </CardContent>
            </Card>
          </div>
