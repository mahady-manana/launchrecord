...
[
    {
      ...
      "description": "Verify robots.txt, meta robots, and sitemap so AI bots can fetch key content.",
      "weight": 10
    },
    {
      "id": "schema_jsonld",
    ...
    },
    {
      "id": "answer_blocks",
      "name": "Answer blocks",
      "description": "Ensure headings, paragraphs, and lists surface direct, concise answers.",
      "weight": 10
    },
    {
      "id": "topic_authority",
      "name": "Topical authority/cluster",
      "description": "Confirm topic clusters, internal links, and semantic structure reinforce authority.",
      "weight": 10
    },
    {
      "id": "entities_relations",
      "name": "Entities/relations",
      "description": "Identify core entities (people, orgs, products, tech) and their relationships.",
      "weight": 5
    },
    {
      "id": "citation_author",
      "name": "Citations/author",
      "description": "Provide author info, references, and outbound links to credible sources.",
      "weight": 10
    },
    {
      "id": "clarity_structure",
      "name": "Clarity/structure",
      "description": "Use bullets, tables, and numbered lists; minimize marketing fluff.",
      "weight": 5
    },
    {
      "id": "freshness",
      "name": "Freshness",
      "description": "Check last-modified signals, update cadence, and recent examples.",
      "weight": 5
    },
    {
      "id": "external_mentions",
      "name": "External mentions",
      "description": "Look for third-party mentions on Reddit, GitHub, blogs, and papers.",
      "weight": 5
    },
    {
      "id": "featured_snippet",
      "name": "Featured snippet fit",
      "description": "Include short definitions, steps, and FAQs suitable for snippets.",
      "weight": 5
    },
    {
      "id": "answer_depth",
    ...
    },
    {
      ...
      "description": "Keep content structured with short paragraphs, tables, and Q&A blocks.",
      "weight": 5
    },
    {
    ...
    },
    {
      "id": "uniqueness",
      "name": "Uniqueness",
      "description": "Check for originality, plagiarism risk, and unique data/research.",
      "weight": 5
    }
  ]
