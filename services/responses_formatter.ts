import { format_audit_v1 } from "@/reports/format_v1";
...
6. Check AEO Checklist. Make sure the AEO Checklist and the Audit aeo_index.audit have proper id.: ${aeo_checklist}
