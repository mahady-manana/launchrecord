...
export interface SummarySection {
  ...
  currents: string[];
  /** Comments pointing out problems (no fixes, just observations) */
  comments: string[];
}
...
export interface FirstImpressionReport {
  ...
  /** Overall comment about the hero section */
...
export interface PositioningSummary {
  ...
  current: string;
  /** Comments pointing out positioning issues */
  comments: string[];
...
export interface SIOV5Report {
  /** Overall score 0-100 */
  score: number;
  /** Overall problem statement (3 sentences covering positioning, clarity, AEO) */
  statement: string;
...
export interface ClaritySummary {
  ...
  current: string;
  /** Comments pointing out clarity issues */
  comments: string[];
  /** Suggested messaging */
  suggested: string;
}
